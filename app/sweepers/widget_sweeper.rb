class WidgetSweeper < ActionController::Caching::Sweeper
  ...
  def self.widgets
    ['latest_activity','newest_newswires','blog_roll','feed_roll','auto_feature','top_stories', 'stories_list', 'active_stories', 'most_discussed_stories', 'top_users', 'top_ideas', 'top_events', 'featured_items', 'newest_users', 'newest_ideas', 'header', 'fan_application', 'prompt_permissions', 'newest_images', 'newest_videos','announcements','welcome_panel']
  end
