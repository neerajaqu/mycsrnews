...
settings = [
 { :key_sub_type => 'options', :key_name => 'exclude_articles_from_news',  :layout => "false" },
 { :key_sub_type => 'options', :key_name => 'site_notification_user',  :layout => (User.admins.last || nil) },
 { :key_sub_type => 'options', :key_name => 'enable_activity_popups',  :layout => "true" },
 { :key_sub_type => 'options', :key_name => 'allow_web_auth',  :layout => (APP_CONFIG['allow_web_auth'] || "false" ) },
 { :key_sub_type => 'options', :key_name => 'site_title',  :layout => (APP_CONFIG['site_title'] || "Default Site Title" ) },
 { :key_sub_type => 'options', :key_name => 'site_topic', :layout => (APP_CONFIG['site_topic'] || "Default Topic" ) },
 { :key_sub_type => 'options', :key_name => 'contact_us',  :layout => (APP_CONFIG['contact_us_recipient'] || "admin@email.com,me@email.com,support@email.com" ) },
 { :key_sub_type => 'options', :key_name => 'firstnameonly', :layout => (APP_CONFIG['firstnameonly'] || "false" ) },
 ...
 { :key_sub_type => 'twitter', :key_name => 'oauth_consumer_secret', :layout => (APP_CONFIG['twitter_oauth_secret'] || "Heu0GGaRuzn762323gg0qFGWCp923viG8Haw" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_events_min_votes', :layout => (APP_CONFIG['tweet_events_min_votes'] || "15" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_events_limit', :layout => (APP_CONFIG['tweet_events_limit'] || "3" ) }, 
 { :key_sub_type => 'twitter', :key_name => 'tweet_stories_min_votes', :layout => (APP_CONFIG['tweet_stories_min_votes'] || "15" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_stories_limit', :layout => (APP_CONFIG['tweet_stories_limit'] || "3" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_questions_min_votes', :layout => (APP_CONFIG['tweet_questions_min_votes'] || "15" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_questions_limit', :layout => (APP_CONFIG['tweet_questions_limit'] || "3" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_ideas_min_votes', :layout => (APP_CONFIG['tweet_ideas_min_votes'] || "15" ) },
 { :key_sub_type => 'twitter', :key_name => 'tweet_ideas_limit', :layout => (APP_CONFIG['tweet_ideas_limit'] || "3" ) },   
 { :key_sub_type => 'twitter', :key_name => 'tweet_featured_items', :layout =>(APP_CONFIG['tweet_featured_items'] || "true" ) }, 
 { :key_sub_type => 'twitter', :key_name => 'tweet_popular_items', :layout =>"false" }, 
 { :key_sub_type => 'bitly', :key_name => 'bitly_username', :layout =>(APP_CONFIG['bitly_username'] || "username" ) },
 { :key_sub_type => 'bitly', :key_name => 'bitly_api_key', :layout =>(APP_CONFIG['bitly_api_key'] || "api_key" ) },
 { :key_sub_type => 'facebook', :key_name => 'app_id', :layout => (APP_CONFIG['facebook_application_id'] || "111111111111" ) },
 { :key_sub_type => 'welcome_panel', :key_name => 'welcome_layout', :layout => "default", :hint => 'e.g. default, thumb, host, banner' },
 { :key_sub_type => 'welcome_panel', :key_name => 'welcome_image_url', :layout => APP_CONFIG['base_url']+"/images/default/icon-fan-app.gif", :hint => "Full (absolute) URL to image, e.g. #{APP_CONFIG['base_url']}/images/default/icon-fan-app.gif, recommended sizes: thumb 50 x 50 or banner = 300 x 90"},
 { :key_sub_type => 'welcome_panel', :key_name => 'welcome_host', :layout => "0", :hint => 'userid of host profile image to use'},
 { :key_sub_type => 'stats', :key_name => 'google_analytics_account_id', :layout => (APP_CONFIG['google_analytics_account_id'] || "UF-123456890-7" ) },
 { :key_sub_type => 'stats', :key_name => 'google_analytics_site_id', :layout => (APP_CONFIG['google_analytics_site_id'] || "1231232" ) },
 { :key_sub_type => 'sitemap', :key_name => 'google-site-verification', :layout => "WS8kMC8-Ds77777777777Xy6QcmRpWAfY" },
 { :key_sub_type => 'sitemap', :key_name => 'yahoo-site-verification', :layout => "WS87ds77" },
 { :key_sub_type => 'ads', :key_name => 'platform', :layout => (APP_CONFIG['ad_platform'] || "google" ) },
 { :key_sub_type => 'ads', :key_name => 'helios_sitepage', :layout => (APP_CONFIG['helios_sitepage'] || "youraddomain.com/yourfacebookproject.htm" ) },
 { :key_sub_type => 'ads', :key_name => 'helios_url', :layout => (APP_CONFIG['helios_url'] || "http://subdomain.xxx.com" ) },
 { :key_sub_type => 'ads', :key_name => 'helios_script_url', :layout => (APP_CONFIG['helios_script_url'] || "http://scriptsubdomain.xxx.com" ) },
 { :key_sub_type => 'ads', :key_name => 'helios_list_pos', :layout => (APP_CONFIG['helios_list_pos'] || "728x90_1,468x60_1,300x250_1,160x600_1,250x250_1,200x200_1,336x280_1" ) },
 { :key_sub_type => 'ads', :key_name => 'google_adsense_account_id', :layout => (APP_CONFIG['google_adsense_account_id'] || "ca-pub-9975156792632579" ) },
 { :key_sub_type => 'ads', :key_name => 'google_adsense_slot_name', :layout => (APP_CONFIG['google_adsense_slot_name'] || "Needle_Small") }
]
...
activity_scores = [
 { :key_sub_type => 'importance', :key_name => 'karma',  :layout => 1, :hint => "Multiple used when calculating karma actions. High setting maximizes impact of quality of posts as judged by other readers" },
 { :key_sub_type => 'importance', :key_name => 'participation',  :layout => 0, :hint => "Multiple used when calculating participation actions. Low setting minimizes impact of posting on user scores." },
 { :key_sub_type => 'participation', :key_name => 'story',  :layout => 1, :hint => "Points awarded when user creates a story" },
 { :key_sub_type => 'participation', :key_name => 'article',  :layout => 1, :hint => "Points awarded when user creates a article" },
 { :key_sub_type => 'participation', :key_name => 'idea',  :layout => 1, :hint => "Points awarded when user creates a idea" },
 { :key_sub_type => 'participation', :key_name => 'event',  :layout => 1, :hint => "Points awarded when user creates a event" },
 { :key_sub_type => 'participation', :key_name => 'topic',  :layout => 1, :hint => "Points awarded when user creates a topic" },
 { :key_sub_type => 'participation', :key_name => 'resource',  :layout => 1, :hint => "Points awarded when user creates a resource" },
 { :key_sub_type => 'participation', :key_name => 'question',  :layout => 1, :hint => "Points awarded when user creates a question" },
 { :key_sub_type => 'participation', :key_name => 'answer',  :layout => 1, :hint => "Points awarded when user creates a answer" },
 { :key_sub_type => 'participation', :key_name => 'comment',  :layout => 1, :hint => "Points awarded when user creates a comment" },
 { :key_sub_type => 'participation', :key_name => 'share',  :layout => 1, :hint => "Points awarded when user shares another reader\'s item" },
 { :key_sub_type => 'participation', :key_name => 'invite',  :layout => 1, :hint => "Points awarded when user invites a friend" },
 { :key_sub_type => 'karma', :key_name => 'item_vote',  :layout => 1, :hint => "Points awarded when item created by user is liked" },
 { :key_sub_type => 'karma', :key_name => 'item_comment',  :layout => 1, :hint => "Points awarded when item created by user is commented on" },
 { :key_sub_type => 'karma', :key_name => 'item_shared',  :layout => 1, :hint => "Points awarded when item created by user is shared or tweeted" },
 { :key_sub_type => 'karma', :key_name => 'invite_accepted',  :layout => 1, :hint => "Points awarded when invite from user is accepted" }
]
...
activity_scores.each do |activity_score|
  ...
  Metadata::ActivityScore.create!({
		:data => {
		  ...
		  :activity_score_value => activity_score[:layout],
