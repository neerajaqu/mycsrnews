ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :widgets, :collection => { :newswires => [:get], :questions => [:get], :forum_roll => [:get], :blog_roll => [:get], :blogger_profiles => [:get], :fan_application => [:get], :add_bookmark => [:get], :user_articles => [:get], :articles => [:get], :stories => [:get], :activities => [:get]  }, :layout => 'widgets'
