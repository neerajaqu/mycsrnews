ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :widgets, :collection => { :blogger_profiles => [:get], :fan_application => [:get], :add_bookmark => [:get], :user_articles => [:get], :articles => [:get], :stories => [:get], :activities => [:get]  }, :layout => 'widgets'
